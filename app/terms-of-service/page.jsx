        ...
        <div className="max-w-7xl mx-auto mb-10 text-justify">
          <div>
            <div className={`section-title text-3xl md:text-4xl`}>
              <h2 className={`leading-tight mt-6 font-bold`}>TERMS OF USE</h2>
            ...
            <section className="text-gray-600 mt-8 font-medium leading-relaxed space-y-6">
              ...
              <p>We are “We Code That” ("Company," "we," "us," "our").</p>
              ...
              <p>
                ...
                or by mail to “No.3, 5th Cross Street, MGR Nagar,
                Thirumullaivoyal, Chennai - 600062 Chennai, Tamil Nadu 600062
                India”.
              </p>
              ...
              <p>
                ...
                ("you"), and “We Code That”, concerning your access to and use
            ...
            >
              ...
              <p>
                ...
                the&nbsp;
                <a
                  href="https://app.termly.io/dashboard/website/b2f544f2-0b2f-4372-b852-b75f9325c854/terms-of-service#prohibited"
                  className="text-blue-600"
                >
              ...
              <p>
                ...
                Terms, please address your request to: “support@wecodethat.com”.
            ...
            >
              ...
              <ul className="space-y-4 ml-10 list-disc">
                <li>
                  ...
                  We reserve the right to monitor the Services to ensure
                  compliance with these Legal Terms.
                </li>
                <li>
                  <strong>Take appropriate legal action:</strong> We have the
                  right to take legal action against anyone who, at our
                  discretion, violates the law or these Legal Terms, including
                  reporting such users to law enforcement authorities.
                </li>
                <li>
                  <strong>
                    Refuse, restrict access, or disable Contributions:
                  </strong>{" "}
                  We may refuse, restrict access to, limit the availability of,
                  or disable any of your Contributions, or any portion thereof,
                  at our sole discretion.
                </li>
                <li>
                  <strong>Remove excessive files or content:</strong> We reserve
                  the right to remove from the Services or disable any files and
                  content that are excessively large or burdensome to our
                  systems, with or without notice.
                </li>
                <li>
                  <strong>Manage the Services:</strong> We manage the Services
                  in a way that protects our rights and property and facilitates
            ...
            >
              ...
              <p>
                ...
                laws of India. We Code That and yourself irrevocably consent
                that the courts of Chennai, India shall have exclusive
            ...
            >
              ...
              <p>
                ...
                number of arbitrators shall be 1. The seat, or legal place, or
                arbitration shall be Chennai. The language of the proceedings
                shall be English. The governing law of these Legal Terms shall
                be substantive law of India, Chennai.
              </p>

              <h4 className="text-xl font-semibold text-black">Restrictions</h4>
