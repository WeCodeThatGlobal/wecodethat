    ...
    return (
        <section className="py-24 bg-gray-100 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 space-y-10">
                ...
                <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4 md:children:!border-t-0 sm:divide-x divide-gray-100 dark:divide-gray-900 sm:children:even:border-transparent ">
