...
const CallUsCard = () => {
  return (
    <div classNameName="bg-slate-100 rounded-lg">
      <img
        decoding="async"
      ...
      <div className="pt-8 pb-6 rounded-b-lg bg-gray-900 relative text-center">
        <div className="icon-boxs bg-blue-600 absolute left-0 right-0 -top-8 mx-auto w-16 h-16 rounded-full text-center flex items-center justify-center">
          <svg
