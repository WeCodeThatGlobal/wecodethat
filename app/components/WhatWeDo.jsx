      ...
      <div className="px-4 sm:px-10 md:px-12 lg:px-5 max-w-7xl mx-auto">
        <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[-50px] items-center">
          ...
          <div className="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] mt-[50px] max-w-full relative">
            <h2 className="!text-[.75rem] uppercase text-white !mb-3 tracking-[0.02rem] leading-[1.35]">
              What We Do?
            </h2>
            <h3 className="text-lg font-semibold lg:text-4xl mb-3 !leading-[1.3] text-white">
              Digital Solutions <br />
              Designed with You in Mind
            </h3>
            <p className="text-[17px] leading-relaxed font-medium mb-3 text-white">
