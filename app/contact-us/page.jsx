          ...
          <div className="bg-slate-100 rounded-md p-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div className="col-span-2">
                ...
                <div>
                  <iframe
                    data-tally-src="https://tally.so/embed/wz2B9a?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
                    loading="lazy"
                    width="100%"
                    height="100"
                    frameborder="0"
                  ...
                  <div className="divide-y divide-gray-600 mt-4">
                    <div className="flex items-center group py-4">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-400">support@wecodethat.com</p>
                      </div>
                    </div>
                    <div className="flex items-center group py-4">
                      <div className="bg-slate-600 rounded-md text-white p-3 group-hover:bg-blue-500">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-400">+919094321163</p>
                      </div>
                    </div>
                    <div className="flex items-center group py-4">
                      <div className="bg-slate-600 rounded-md text-white p-3 group-hover:bg-blue-500">
