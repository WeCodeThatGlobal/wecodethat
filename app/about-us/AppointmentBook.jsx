      ...
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
          ...
          <p className="mx-auto mt-6 max-w-4xl text-pretty text-lg/8 text-gray-300">
            Whether it’s a website, an e-commerce platform, a mobile app, or a
            marketing strategy our team is ready.
            <br />
            Get in touch to discuss your goals and explore how we can turn your
            ideas into reality.
          </p>
