                ...
                <strong>
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="subtitle">
                      Last updated{" "}
                      <bdt className="question">January 22, 2025</bdt>
                    </span>
                  </span>
                </strong>
              </span>
              ...
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  ...
                  <span data-custom-class="body_text">
                    ...
                    <strong>process</strong>'<bdt className="else-block" />)
                  ...
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(127, 127, 127)" }}>
                      <span data-custom-class="body_text">
                        ...
                        <bdt className="question">support@wecodethat.com</bdt>.
                      </span>
                    </span>
                  </span>
                </div>
                ...
                <div style={{ lineHeight: "1.5" }}>
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdt className="else-block" /> in certain jurisdictions,
                ...
                <div style={{ lineHeight: "1.5" }}>
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdt className="block-component" />
                      unauthorised
                      <bdt className="else-block" /> third parties will not be
                      able to defeat our security and improperly collect,
                    ...
                    <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                      <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
                          ...
                          files viewed, searches, and other actions you take
                                  ...
                                  >
                                    <span style={{ fontSize: 15 }}>
                                      <span data-custom-class="body_text">
                                        ...
                                        <bdt className="block-component" />
                                        personalised
                                        <bdt className="else-block" /> content
                                        and advertising tailored to your
